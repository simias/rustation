...
impl Cpu {
    ...
    fn decode_and_execute(&mut self, instruction: Instruction) {
        let instruction_name = match instruction.function() {
            0b000000 => match instruction.subfunction() {
                0b000000 => { self.op_sll(instruction); "op_sll" },
                0b000010 => { self.op_srl(instruction); "op_srl" },
                0b000011 => { self.op_sra(instruction); "op_sra" },
                0b000100 => { self.op_sllv(instruction); "op_sllv" },
                0b000110 => { self.op_srlv(instruction); "op_srlv" },
                0b000111 => { self.op_srav(instruction); "op_srav" },
                0b001000 => { self.op_jr(instruction); "op_jr" },
                0b001001 => { self.op_jalr(instruction); "op_jalr" },
                0b001100 => { self.op_syscall(instruction); "op_syscall" },
                0b001101 => { self.op_break(instruction); "op_break" },
                0b010000 => { self.op_mfhi(instruction); "op_mfhi" },
                0b010001 => { self.op_mthi(instruction); "op_mthi" },
                0b010010 => { self.op_mflo(instruction); "op_mflo" },
                0b010011 => { self.op_mtlo(instruction); "op_mtlo" },
                0b011000 => { self.op_mult(instruction); "op_mult" },
                0b011001 => { self.op_multu(instruction); "op_multu" },
                0b011010 => { self.op_div(instruction); "op_div" },
                0b011011 => { self.op_divu(instruction); "op_divu" },
                0b100000 => { self.op_add(instruction); "op_add" },
                0b100001 => { self.op_addu(instruction); "op_addu" },
                0b100010 => { self.op_sub(instruction); "op_sub" },
                0b100011 => { self.op_subu(instruction); "op_subu" },
                0b100100 => { self.op_and(instruction); "op_and" },
                0b100101 => { self.op_or(instruction); "op_or" },
                0b100110 => { self.op_xor(instruction); "op_xor" },
                0b100111 => { self.op_nor(instruction); "op_nor" },
                0b101010 => { self.op_slt(instruction); "op_slt" },
                0b101011 => { self.op_sltu(instruction); "op_sltu" },
                _        => { panic!("Unhandled instruction {}", instruction); "" },
            },
            0b000001 => { self.op_bxx(instruction); "op_bxx" },
            0b000010 => { self.op_j(instruction); "op_j" },
            0b000011 => { self.op_jal(instruction); "op_jal" },
            0b000100 => { self.op_beq(instruction); "op_beq" },
            0b000101 => { self.op_bne(instruction); "op_bne" },
            0b000110 => { self.op_blez(instruction); "op_blez" },
            0b000111 => { self.op_bgtz(instruction); "op_bgtz" },
            0b001000 => { self.op_addi(instruction); "op_addi" },
            0b001001 => { self.op_addiu(instruction); "op_addiu" },
            0b001010 => { self.op_slti(instruction); "op_slti" },
            0b001011 => { self.op_sltiu(instruction); "op_sltiu" },
            0b001100 => { self.op_andi(instruction); "op_andi" },
            0b001101 => { self.op_ori(instruction); "op_ori" },
            0b001110 => { self.op_xori(instruction); "op_xori" },
            0b001111 => { self.op_lui(instruction); "op_lui" },
            0b010000 => { self.op_cop0(instruction); "op_cop0" },
            0b010001 => { self.op_cop1(instruction); "op_cop1" },
            0b010010 => { self.op_cop2(instruction); "op_cop2" },
            0b010011 => { self.op_cop3(instruction); "op_cop3" },
            0b100000 => { self.op_lb(instruction); "op_lb" },
            0b100001 => { self.op_lh(instruction); "op_lh" },
            0b100010 => { self.op_lwl(instruction); "op_lwl" },
            0b100011 => { self.op_lw(instruction); "op_lw" },
            0b100100 => { self.op_lbu(instruction); "op_lbu" },
            0b100101 => { self.op_lhu(instruction); "op_lhu" },
            0b100110 => { self.op_lwr(instruction); "op_lwr" },
            0b101000 => { self.op_sb(instruction); "op_sb" },
            0b101001 => { self.op_sh(instruction); "op_sh" },
            0b101010 => { self.op_swl(instruction); "op_swl" },
            0b101011 => { self.op_sw(instruction); "op_sw" },
            //0b101110 => { self.op_swr(instruction); "op_swr" },
            _        => { panic!("Unhandled instruction {}", instruction); "" },
        };
        println!("Executing instruction: {}", instruction_name);
    }    
